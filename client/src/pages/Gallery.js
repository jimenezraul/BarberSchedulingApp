...
const Gallery = () => {
  ...
  return (
    <div className='flex flex-wrap justify-center w-full p-3 container mx-auto flex-1'>
      <div className='flex flex-wrap  mb-2 md:mb-0 w-full bg-gray-700 text-gray-300 rounded-lg shadow-lg border border-gray-600'>
